    ...
    <p>
        <form action="{{ route('mails.store') }}" method="POST">
            ...
            <p>
                ...
                <input type="text" id="from" name="from" value="{{ old('from') }}" placeholder="Field is required">
                @error('from')<div class="alert alert-danger">{{ $message }}</div>@enderror
            </p>
            <p>
                <label for="to">To</label>
                <input type="text" id="to" name="to" value="{{ old('to') }}" placeholder="Field is required">
                @error('to')<div class="alert alert-danger">{{ $message }}</div>@enderror
            </p>
            <p>
                <label for="title">Title</label>
                <input type="text" id="title" name="title" value="{{ old('title') }}" placeholder="Field is required">
